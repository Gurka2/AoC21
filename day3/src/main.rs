...
fn main() {
    ...
    println!("Part 2: {}", get_life_rating(&values, 0, true));
}

pub fn get_life_rating(values: &Vec<&str>, index: usize, oxy: bool) ->i128 {
...
pub fn bi_to_dec(code: &str) -> i128 {
    ...
    for (i, value) in code.chars().enumerate() {
        ...
        dec += (value as i128 - 48)*2_i128.pow((len - i as u32 - 1).try_into().unwrap());
    }
    return dec;
